                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="profile-head">
                                    <h5>Job Title: <s:property value="jobTitle"/></h5>
                    ...
                    <div class="col-md-2">
                        <p><a class="profile-edit-btn" href="apply.jsp">Apply</a></p>
                    </div>
                </div>
                <div class="row">
                	<div class="col-md-4">
                        ...
                        <div class="tab-content profile-tab" id="myTabContent">
                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <p><s:property value="jobDescription" /></p>
                                            </div>
                                        </div>
                            </div>
                        </div>
