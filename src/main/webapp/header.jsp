...
<nav class="navbar navbar-expand-lg navbar-light" style="background-color: #FFC312;">
  <a class="navbar-brand" href="home.jsp">Community Portal</a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
        <s:a cssClass="nav-link" action="viewProfile">Profile</s:a>
      </li>
      <li class="nav-item">
        <s:a cssClass="nav-link" action="viewJobPost">JobPost</s:a>
      </li>
      <li class="nav-item">
